...
public class JSubjectServiceImp extends SubjectServiceImp<JPerson> {
    ...
    private DetachedCriteria query = DetachedCriteria.forClass(JPerson.class);
    ...
    public List<JPerson> findByNameType(String fullName, String regNumberOrUnp, Integer subjectType ) throws ServiceDaoException {
